...
<body id='myBody'>
    ...
    <script>
        ...
        me.projects.push(new Project("Dentist's website", true, "dentist.jpg", "https://dissertationjb.000webhostapp.com/", "Mock-up of dentist's website. I have made it in order to simplify work with future projects.", "https://github.com/Tosini13/dental-website"));
        me.projects.push(new Project("Bachelor's Dissertation", false, "dissertation.jpg", "https://poland13jakubartosik.000webhostapp.com", "Aim of my dissertation project was to create school management safety web application. In order to develop the website I used AJAX, React.js, PHP, MySQL and of course HTML5, CSS3.", "https://github.com/Tosini13/dissertationProject"));
        me.projects.push(new Project("Mesh Coach", false, "meshCoach.jpg", "http://oczkotrenera.pl", "Information page for 'Oczko Trenera'. I am doing webiste for tournament managing within this project as well."));
        me.projects.push(new Project("My previous porfolio", false, "oldPortfolio.jpg", "https://myauxiliary.000webhostapp.com/", "My previous portfolio made in July 2019. One of my first webpages"));
        me.update();
